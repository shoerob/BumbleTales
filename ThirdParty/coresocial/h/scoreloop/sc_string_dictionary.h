 ...
 * @return SC_String_h The value kept under given key or NULL, when not found.
 */
 ...
 *
 * Dictionary supports very simple iteration model. There can be only one iteration going at a time. 
 * This very call starts iteration if it was not ongoing, or restarts current iteration from the first key/value pair.
 *
 * @param self An opaque handle for the SC_StringDictionary instance.
 */
 ...
 *
 * This methd returns the number of items stored in the dictionary.
 *
