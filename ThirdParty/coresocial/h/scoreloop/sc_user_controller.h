 ...
 *  Important note:
 *
 * Do not modify a user object or one of its sub-objects while one of the following asynchronous methods is in progress, as this might cause undefined results:
