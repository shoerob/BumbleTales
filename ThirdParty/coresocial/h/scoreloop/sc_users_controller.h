 ...
 * @{
 * The \ref SC_UsersController requests lists of SC_User objects from
 * the server based on a variety of different criteria:
 *  - User login ID
 *  - User email address
 ...
 * -# All the other search criterias are then ignored.
