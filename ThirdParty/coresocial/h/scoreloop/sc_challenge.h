 ...
 *
 * See @link coresocial-challenges About Challenges @endlink for a more detailed explanation of a Scoreloop challenge.
 * See @link integration-guide-challenges Integrating Challenges @endlink for more information about how to integrate challenges into your game.
 *
 * @sa SC_Session, SC_ChallengeController, SC_ChallengesController, @link integration-guide-challenges Integrating Challenges @endlink,
 ...
 *
 * For example, a challenge is deemed invalid if the contestant and contender are the same Scoreloop user.
 *
 * @param self An opaque handle for the SC_Challenge instance.
 ...
 *
 * This method returns @c SC_TRUE, when the contender has played the challenge.
 * Open challenges can be accepted by any Scoreloop user.
 *
 * @param self An opaque handle for the SC_Challenge instance.
 ...
 *
 * This method returns @c SC_TRUE if the challenge has been rejected by a contestant.
