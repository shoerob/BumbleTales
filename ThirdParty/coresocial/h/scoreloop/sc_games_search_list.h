 ...
 * @{
 *
 * \ref SC_GamesSearchList in an abstraction for filtering
 * a games that are stored on the Scoreloop servers.
 *
 * GamesSearchLists are used by the \ref SC_GamesController
 * to filter games respectively.
 *
 * GamesSearchLists can be set up to filter games according to:
