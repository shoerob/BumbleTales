...
/**
* @file        scoreloopcore.h
* @brief       Umbrella header file including all public headers of scoreloop core.
*
* @addtogroup  SC_Init
* @{
*/

#ifndef __SCORELOOPCORE_H__ 
#define __SCORELOOPCORE_H__
...
#include <scoreloop/sc_version.h>

#endif /* __SCORELOOPCORE_H__ */
