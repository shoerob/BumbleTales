 ...
 *
 * This method creates an instance of SC_String, copying given length bytes from a given buffer.
 * The string instance is created with a reference count equal to 1.
 *
 * @param   pSelf  Opaque handle of the string instance created.
 * @param   text   A pointer to the UTF-8 encoded char data.
 ...
 *
 * This method does a bytewise comparison the UTF8 data of the two strings. Note that strings on the Scoreloop servers might be normalized and change the byte sequence.
