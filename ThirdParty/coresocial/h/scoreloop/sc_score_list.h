 ...
 *
 * @sa SC_ScoresController,  @link integration-guide-scores Integrating Leaderboards @endlink,
 * @link coresocial-leaderboards About Scores and Leaderboards @endlink.
 */
