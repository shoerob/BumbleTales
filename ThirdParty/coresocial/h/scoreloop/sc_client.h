 ...
 * @param currency The unique game specific currency code assigned by Scoreloop when
 *  the game was registered on
 *  <a href="https://developer.scoreloop.com">https://developer.scoreloop.com</a>.
 * @param languages The comma-separated list of languages that needs to be specified to support localization of Awards.
 * Passing in "en" would be then English. Current language on the device is intersected with this list to pick up the valid translation.
*  If none is common, first one from that list is used. English ("en") is used by the default, if nothing specified.
 * @return SC_Error_t A return code (A value of SC_OK indicates success, any other value indicates an error). 
 *
 * @note The object is created with a reference count equal to 1.
 *       Please note that on BlackBerry this call will prompt for BBID credentials.
 */
 ...
 * 
 * This method creates an instance of SC_ScoresController. The controller
 ...
 *
 * This method creates an instance of SC_ScoreController. The controller
 ...
 *
 * This method creates an instance of SC_RankingController. The controller
 ...
 *
 * This method creates an instance of SC_MessageController. The controller
 ...
 *
 * This method creates an instance of SC_ChallengeController. The controller
 ...
 *
 * This method creates an instance of SC_UserController. The controller
 ...
 *
 * This method creates an instance of SC_UsersController. The controller
 ...
 *
 * This method creates an instance of SC_LocalAchievementsController. The controller
