 ...
 *
 *  If any direct challenges exist for the user, these will be requested first.
 *  If no direct challenges exist, then all open challenges will be requested instead.
 *
