 ...
 * @{
 *
 * The collection of the \ref SC_Achievement that are available in the game.
 *
 * To get a specific \ref SC_Achievement, call SC_AchievementList_GetAchievement(), which retrieves the
 * achievement at the specified index in the list.
 *
 * Calling SC_AchievementList_GetCount() returns the number of achievements
 * in the list.
 */
