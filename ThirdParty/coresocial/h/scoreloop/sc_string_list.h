 ...
 *
 * This method increments the reference count for the current SC_StringList instance.
 *
 ...
 *
 * This method decrements the reference count for the current SC_StringList instance.
